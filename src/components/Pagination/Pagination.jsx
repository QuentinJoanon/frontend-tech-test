...
function Pagination({ currentPage, totalPages, onPageChange }) {
  ...
  // TODO: instead of looping like this, we use to use the map function of an array.
  // see https://dev.to/inverseswirl/4-easy-ways-to-loop-data-in-react-array-map-method-4f3l
